package com.liux.heartreader.utils;

import android.content.Context;
import android.content.SharedPreferences;


import com.liux.heartreader.application.HeartReaderApplication;
import com.liux.heartreader.constants.Constants;
...
public class SPUtils {
    ...
    private static SharedPreferences getSharedPreference(String fileName) {
        return HeartReaderApplication.getInstance().getSharedPreferences(fileName, Context.MODE_PRIVATE);
    }
